function Linuxprereq(){
	...
	local preReqsPath="$2" #ex /root/CentOS_Offline_PreReqs
	local tarName="$3" #ex docker-18.09.6.tgz
 	 local composeFolder="$4" #ex docker-compose-Linux-x86_64 
	local dialogFilename="$5" #ex dialog-1.2-5.20130523.el7.x86_64.rpm
	local JDKFilename="$6" #ex jdk-8u241-linux-x64.rpm
